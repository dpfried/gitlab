...
if __name__ == "__main__":
    ...
    csv_writer = csv.DictWriter(csv_file, ['url', 'stars', 'license', 'main_language', 'is_fork', 'last_activity_at', 'tags', 'languages'])

    csv_writer.writeheader()

    usable_repos = 0

    for project_ix, project in enumerate(it):
        ...
        try:
            ...
            print(f"{project_ix:_}\t{record}")

        except Exception as e:
            print(e)

        if (project_ix + 1) % 100 == 0:
            print("**printing stats**")
            print(f"{usable_repos:_} / {project_ix + 1:_} usable repos")
